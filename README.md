...
* **Secure Authentication:** JWT-based login with BCrypt password hashing, security questions, and **Two-Factor Authentication (2FA) via Email OTP**.
* **Money Transfers:** Send/Request money via Email, Phone, or Account ID.
* **Wallet Management:** Add/Withdraw funds using linked Payment Methods (Enhanced UI showing last 4 card digits).
...
* **Analytics Dashboard:** Graphical, real-time Chart.js integration displaying cash flow (Total Received/Sent), outstanding invoices, and revenue stats.
...
* **Dynamic UI Improvements:** Global button loading states (spinners and disabling) for form submissions to prevent duplicate transactions.
